...
void ABaseAIController::ShouldStartFire(bool& ReturnValue)
{
}

void ABaseAIController::ShouldStopFire(bool& ReturnValue)
{
}
...
void ABaseAIController::ShouldUpdateAim(bool& ReturnValue)
{
}
